...
class Kernel:
    ...
    _maxHistorySize = 1 # maximum length of the _inputs and _responses lists
    _maxRecursionDepth = 500 # maximum number of recursive <srai>/<sr> tags before the response is aborted.
    ...
    def _deleteSession(self, sessionID):
        ...
        if self._sessions.has_key(sessionID):
            # should this be: self._sessions.pop(sessionID) ???
